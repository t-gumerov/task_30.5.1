# Здание 30.3.1
# п.5. Написать тест, который проверяет, что на странице со списком
# питомцев пользователя в списке нет повторяющихся питомцев. (Сложное задание).
...
def test_no_duplicate_pets(go_to_my_pets):
    '''Проверка того, что на странице со списком питомцев
    пользователя в списке нет повторяющихся питомцев'''
