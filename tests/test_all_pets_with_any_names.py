# Здание 30.3.1
# п.4. Написать тест, который проверяет, что на странице со списком
# питомцев пользователя у всех питомцев разные имена.
...
def test_all_pets_with_any_names(go_to_my_pets):
    ...
    пользователя у всех питомцев разные имена'''
